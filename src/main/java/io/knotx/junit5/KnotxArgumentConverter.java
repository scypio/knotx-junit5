...
public class KnotxArgumentConverter extends SimpleArgumentConverter {
  ...
  protected Object convert(Object source, Class<?> targetType) throws ArgumentConversionException {
    ...
    if (targetType.equals(JsonObject.class)) {
      return createJsonObject(toConvert);
    }
   ...
   */
  private static Fragment createFragmentMock(String fragmentParameters) throws IOException {
  ...
  private static JsonObject createJsonObject(String input) {
